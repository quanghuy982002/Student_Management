...
urlpatterns = [
    ...
    path('add_major/', HodViews.add_major, name="add_major"),
    path('add_major_save/', HodViews.add_major_save, name="add_major_save"),
    path('manage_major', HodViews.manage_major, name = "manage_major"),
    path('edit_major/<major_id>/', HodViews.edit_major, name="edit_major"),
    path('edit_major_save/', HodViews.edit_major_save, name="edit_major_save"),
    path('delete_major/<major_id>/', HodViews.delete_major, name="delete_major"),
    ...
    path('hod_add_result/', HodViews.hod_add_result, name="hod_add_result"),
    path('hod_add_result_save/', HodViews.hod_add_result_save, name="hod_add_result_save"),
